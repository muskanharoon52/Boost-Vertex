      ...
      <div data-layer="Container" data-node-id="46-558" className="Container flex-1 h-[606.39px] max-w-[1280px] px-10 inline-flex flex-col justify-start items-start">
        ...
        <div data-layer="Hero Form &amp; Viz" data-node-id="46-583" className="HeroFormViz self-stretch relative inline-flex flex-col justify-start items-start">
          ...
          <div data-layer="Background+Border" data-node-id="46-585" className="BackgroundBorder self-stretch p-8 bg-[#1a1c1c] rounded-xl outline outline-1 outline-offset-[-1px] outline-[#292a2a] flex flex-col justify-start items-start gap-6">
            ...
            <div data-layer="Form" data-node-id="46-591" className="Form self-stretch flex flex-col justify-start items-start gap-4">
              <div data-layer="Container" data-node-id="46-592" className="Container self-stretch inline-flex justify-center items-start gap-4">
                <input type="text" name="firstName" placeholder="First Name" aria-label="First Name" data-layer="Input" data-node-id="46-593" className="Input flex-1 px-4 py-3.5 rounded-lg outline outline-1 outline-offset-[-1px] outline-[#292a2a] inline-flex flex-col justify-start items-start overflow-hidden" />
                <input type="text" name="lastName" placeholder="Last Name" aria-label="Last Name" data-layer="Input" data-node-id="46-596" className="Input flex-1 px-4 py-3.5 rounded-lg outline outline-1 outline-offset-[-1px] outline-[#292a2a] inline-flex flex-col justify-start items-start overflow-hidden" />
              </div>
              <input type="email" name="workEmail" placeholder="Work Email" aria-label="Work Email" data-layer="Input" data-node-id="46-599" className="Input self-stretch px-4 py-3.5 rounded-lg outline outline-1 outline-offset-[-1px] outline-[#292a2a] flex flex-col justify-start items-start overflow-hidden" />
              <input type="url" name="companyWebsite" placeholder="Company Website" aria-label="Company Website" data-layer="Input" data-node-id="46-602" className="Input self-stretch px-4 py-3.5 rounded-lg outline outline-1 outline-offset-[-1px] outline-[#292a2a] flex flex-col justify-start items-start overflow-hidden" />
              <div data-layer="Button:margin" data-node-id="46-605" className="ButtonMargin self-stretch pt-2 flex flex-col justify-start items-start">
                <div role="button" tabIndex={0} onClick={() => setActiveTray("Inquiry")} onKeyDown={(event) => { if (event.key === "Enter" || event.key === " ") setActiveTray("Inquiry"); }} data-action="submit-growth-plan" data-layer="Button" data-node-id="46-606" className="Button self-stretch px-8 py-4 bg-[#c3f400] rounded-lg flex flex-col justify-center items-center">
